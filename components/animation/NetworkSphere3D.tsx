...
export default function NetworkSphere3D() {
  ...
  useLayoutEffect(() => {
    ...
    const s1 = new THREE.Mesh(satGeo, satMat); s1.position.set(-0.7, 0.65, 0.2)
    const s2 = new THREE.Mesh(satGeo, satMat); s2.scale.setScalar(0.85); s2.position.set(0.8, -0.2, -0.15)
    g.add(s1, s2)
    ...
    const render = () => {
      ...
      g.rotation.y = t * 0.18
      g.rotation.x = Math.sin(t * 0.25) * 0.08
  ...
  return <div ref={containerRef} className="w-[72vw] max-w-[720px] aspect-square" />
}
